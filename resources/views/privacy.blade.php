...
<body id="top">
    ...
    <section id="privacy" name="privacy" class="privacy">
        <div class="container about-section">
            ...
            <div class="row">
                <div class="col-12">
                    <p><span class="updated-at">Last updated <strong>December 24, 2019</strong></span></p>
                    <p>Thank you for choosing Mountain View Landscaping, LLC (“<b>Company</b>”, “<b>we</b>”, “<b>us</b>”, or “<b>our</b>”). We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about our policy , or our practices with regards to your personal information, please contact us at <a href="mailto:contact@mtnview.email">contact@mtnview.email</a>.</p>
                    <p>When you visit our website (<a href="https://mountainviewlandscapers.com">mountainviewlandscapers.com</a>), mobile application, and use our services, you trust us with your personal information. We take your privacy very seriously. In this privacy policy, we seek to explain to you in the clearest way possible what information we collect, how we use it and what rights you have in relation to it. We hope you take some time to read through it carefully, as it is important. If there are any terms in this privacy policy that you do not agree with, please discontinue use of our Sites or Apps and our services.</p>
                    <p>This privacy policy applies to all information collected through our website (such as <a href="https://mountainviewlandscapers.com">mountainviewlandscapers.com</a>), mobile application, ("<strong>Apps</strong>"), and/or any related services, sales, marketing or events (we refer to them collectively in this privacy policy as the "<strong>Services</strong>").</p>
            ...
            <div class="row">
                <div class="col-12">
                    <h4 class="privacy-np">Table of Contents</h4>
                    <p>
                        <ol class="table-of-contents ">
                            <li><a href="#information-collected">What information do we collect?</a></li>
                            <li><a href="#use-of-information">How do we use your information?</a></li>
                            <li><a href="#information-sharing">Will your information be shared with anyone?</a></li>
                            <li><a href="#cookies">Do we use cookies and other tracking technology?</a></li>
                            <li><a href="#google-maps">Do we use Google Maps?</a></li>
                            <li><a href="#how-long-is-information-stored">How long do we keep your information?</a></li>
            ...
            <div class="row" id="information-collected">
                <div class="col-12">
                    <a href="#information-collected"><h4 class="privacy-np">What information do we collect?</h4></a>
                    ...
                    <p><b>Publicly Available Personal Information.</b> We collect first name, last name, and nickname; current and former address; phone numbers; email addresses; business email; business phone number; and other similar data.</p>
                    <p><b>Personal Information Provided by You.</b> We collect financial information (credit card number, purchase history, invoices); and other similar data.</p>
                    <p><b>Credentials.</b> We collect passwords and similar security information used for authentication and account access.</p>
                    <p><b>Payment Data.</b> We collect data necessary to process your payment if you make purchases, such as your payment instrument number (such as a credit card number), and the security code associated with your payment instrument. All payment data is stored by Stripe and PayPal. You may find their privacy policy link(s) here: <a href="https://stripe.com/privacy">https://stripe.com/privacy</a> and <a href="https://www.paypal.com/va/webapps/mpp/ua/privacy-full">https://www.paypal.com/va/webapps/mpp/ua/privacy-full</a>.</p>
                    ...
                    <p><b>Online Identifiers.</b> We collect devices; tools and protocols, such as IP (Internet Protocol) addresses; applications; cookie identifiers, or others such as the ones used for analytics and marketing; device's geolocation; and other similar data.</p>
                    <h5>Information collected through our apps</h5>
                    <p>If you use our Apps, we may also collect the following information:</p>
                    <ul class="privacy-list-square">
                        ...
                        <li><i>Mobile Device Access.</i> We may request access or permission to certain features from your mobile device, including your mobile device’s reminders, camera, calendar, and other features. If you wish to change our access or permissions, you may do so in your device’s settings.</li>
                        <li><i>Push Notifications.</i> We may request to send you push notifications regarding your account or the mobile application. If you wish to opt-out from receiving these types of communications, you may turn them off in your device’s settings.</li>
                    </ul>
                </div>
            </div>
            <div class="row" id="use-of-information">
                <div class="col-12">
                    <a href="#use-of-information"><h4 class="privacy-np">How do we use your information?</h4></a>
                    ...
                    <ul class="privacy-list-square">
                        ...
                        <li><b>To enforce our terms, conditions and policies for Business Purposes, Legal Reasons and Contractual.</b></li>
            ...
            <div class="row" id="information-sharing">
                <div class="col-12">
                    <a href="#information-sharing"><h4 class="privacy-np">Will your information be shared with anyone?</h4></a>
            ...
            <div class="row" id="cookies">
                <div class="col-12">
                    <a href="#cookies"><h4 class="privacy-np">Do we use cookies and other tracking technologies?</h4></a>
            ...
            <div class="row" id="google-maps">
                <div class="col-12">
                    <a href="#google-maps"><h4 class="privacy-np">Do we use Google Maps?</h4></a>
                    <p>This website, mobile application, or Facebook application uses Google Maps APIs. You may find the Google Maps APIs Terms of Service at <a href="https://cloud.google.com/maps-platform/terms/">https://cloud.google.com/maps-platform/terms/</a>. To better understand Google’s Privacy Policy, please refer to their site at <a href="https://policies.google.com/privacy">https://policies.google.com/privacy</a>.</p>
            ...
            <div class="row" id="how-long-is-information-stored">
                <div class="col-12">
                    <a href="#how-long-is-information-stored"><h4 class="privacy-np">How long do we store your information?</h4></a>
            ...
            <div class="row" id="security">
                <div class="col-12">
                    <a href="#security"><h4 class="privacy-np">How do we keep your information safe?</h4></a>
            ...
            <div class="row" id="minors">
                <div class="col-12">
                    <a href="#minors"><h4 class="privacy-np">Do we collect information from minors?</h4></a>
                    <p>We do not knowingly solicit data from or market to children under 18 years of age. By using the Services or Apps, you represent that you are at least 18 or that you are the parent or guardian of such a minor and consent to such minor dependent’s use of the Services or Apps. If we learn that personal information from users less than 18 years of age has been collected, we will deactivate the account and take reasonable measures to promptly delete such data from our records. If you become aware of any data we have collected from children under age 18, please contact us at <a href="mailto:contact@mtnview.email">contact@mtnview.email.</a></p>
                </div>
            </div>
            <div class="row" id="privacy-rights">
                <div class="col-12">
                    <a href="#privacy-rights"><h4 class="privacy-np">What are your privacy rights?</h4></a>
                    <p>You may review, change, or terminate your account at any time.</p>
                    <p>While our company is based in the United States and we do not target the European geographic, if you are resident in the European Economic Area and you believe we are unlawfully processing your personal information, you also have the right to complain to your local data protection supervisory authority. You can find their contact details here: <a href="http://ec.europa.eu/justice/data-protection/bodies/authorities/index_en.htm">http://ec.europa.eu/justice/data-protection/bodies/authorities/index_en.htm.</a></p>
                    <p>If you have questions or comments about your privacy rights, you may email us at <a href="mailto:contact@mtnview.email">contact@mtnview.email</a>.</p>
            ...
            <div class="row" id="do-not-track">
                <div class="col-12">
                    <a href="#do-not-track"><h4 class="privacy-np">Controls for Do-Not-Track features</h4></a>
            ...
            <div class="row" id="california">
                <div class="col-12">
                    <a href="#california"><h4 class="privacy-np">Do California residents have specific privacy rights?</h4></a>
            ...
            <div class="row" id="updates">
                <div class="col-12">
                    <a href="#updates"><h4 class="privacy-np">Do you make updates to this privacy policy?</h4></a>
                    <p>We may update this privacy policy from time to time. The updated version will be indicated by an updated “Revised” date and the updated version will be effective as soon as it is accessible. If we make material changes to this privacy policy, we may notify you either by prominently posting a notice of such changes or by directly sending you a notification. We encourage you to review this privacy policy frequently to be informed of how we are protecting your information.</p>
                </div>
            </div>
            <div class="row" id="contact-us">
                <div class="col-12">
                    <a href="#contact-us"><h4 class="privacy-np">How do you contact us about this policy?</h4></a>
                    <p>If you have questions or comments about this policy, you may email us at <a href="mailto:contact@mtnview.email">contact@mtnview.email</a> or by mail to:</p>
                    <p>Mountain View Landscaping, LLC<br>
                        2 Main Street<br>
                        Fremont, NH 03044<br>
                        United States</p>
                </div>
            ...
            <div class="row" id="review">
                <div class="col-12">
                    <a href="#review"><h4 class="privacy-np">How can you review, update or delete the data we collect from you?</h4></a>
                    <p>Based on local laws, you may have the right to request access to the personal information we collect from you, change that information, or delete it in some circumstances. To request to review, update, or delete your personal information, please submit a request form by clicking <a href="{{ route('static.homepage') }}#contact">here</a>. We will respond to your request within 30 days.</p>
                </div>
            </div>
        </div>
    </section>
